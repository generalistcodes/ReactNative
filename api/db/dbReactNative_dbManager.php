...
*       https://app.skaffolder.com/#!/register?friend=5ebb1c29bbf7210dd3bd5d2a
*
...
function getConnection() {
	...
	global $db_ReactNative_db_Url, $db_ReactNative_db_User, $db_ReactNative_db_Pass, $db_ReactNative_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_ReactNative_db_Url.";dbname=".$db_ReactNative_db_DbName, $db_ReactNative_db_User, $db_ReactNative_db_Pass);
